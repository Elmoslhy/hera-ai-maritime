...
const SEA: [number, number, number, number][] = [
  [35.5, 39.5, -4.5, 3.5], [37.5, 42.5, 4.0, 9.5], [33.0, 38.0, 10.5, 18.0],
  [34.0, 37.5, 19.0, 25.5], [31.5, 34.5, 25.0, 33.0], [39.5, 43.5, 15.0, 18.5],
  [36.5, 40.0, 23.5, 26.5], [40.5, 43.5, 28.5, 36.5], [35.0, 37.5, 3.0, 9.0],
];
